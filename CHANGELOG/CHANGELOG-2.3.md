...
- Add `checksum/config` annotation to Flow Aggregator. ([#6967](https://github.com/antrea-io/antrea/pull/6967), [@antoninbas])
...
- Add `antreaProxy.disableServiceHealthCheckServer` config to disable the health check server run by Antrea Proxy. ([#6939](https://github.com/antrea-io/antrea/pull/6939), [@antoninbas])
...
- Upgrade go-ipfix to 0.12.0. ([#6897](https://github.com/antrea-io/antrea/pull/6897), [@antoninbas])
...
- Disable TX checksum offload for Antrea host gateway interface when `disableTXChecksumOffload` is set to `true`. ([#6941](https://github.com/antrea-io/antrea/pull/6941), [@hongliangl])
