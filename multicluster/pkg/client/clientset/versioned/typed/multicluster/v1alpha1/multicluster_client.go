...
func (c *MulticlusterV1alpha1Client) TunnelEndpointImports(namespace string) TunnelEndpointImportInterface {
	return newTunnelEndpointImports(c, namespace)
}
