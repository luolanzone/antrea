...
var tunnelendpointsResource = schema.GroupVersionResource{Group: "multicluster.crd.antrea.io", Version: "v1alpha1", Resource: "tunnelendpoints"}

var tunnelendpointsKind = schema.GroupVersionKind{Group: "multicluster.crd.antrea.io", Version: "v1alpha1", Kind: "TunnelEndpoint"}
...
func (c *FakeTunnelEndpoints) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TunnelEndpoint, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(tunnelendpointsResource, c.ns, name), &v1alpha1.TunnelEndpoint{})
...
func (c *FakeTunnelEndpoints) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TunnelEndpointList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(tunnelendpointsResource, tunnelendpointsKind, c.ns, opts), &v1alpha1.TunnelEndpointList{})
...
func (c *FakeTunnelEndpoints) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(tunnelendpointsResource, c.ns, opts))
...
func (c *FakeTunnelEndpoints) Create(ctx context.Context, tunnelEndpoint *v1alpha1.TunnelEndpoint, opts v1.CreateOptions) (result *v1alpha1.TunnelEndpoint, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(tunnelendpointsResource, c.ns, tunnelEndpoint), &v1alpha1.TunnelEndpoint{})
...
func (c *FakeTunnelEndpoints) Update(ctx context.Context, tunnelEndpoint *v1alpha1.TunnelEndpoint, opts v1.UpdateOptions) (result *v1alpha1.TunnelEndpoint, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(tunnelendpointsResource, c.ns, tunnelEndpoint), &v1alpha1.TunnelEndpoint{})
...
func (c *FakeTunnelEndpoints) UpdateStatus(ctx context.Context, tunnelEndpoint *v1alpha1.TunnelEndpoint, opts v1.UpdateOptions) (*v1alpha1.TunnelEndpoint, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(tunnelendpointsResource, "status", c.ns, tunnelEndpoint), &v1alpha1.TunnelEndpoint{})
...
func (c *FakeTunnelEndpoints) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(tunnelendpointsResource, c.ns, name), &v1alpha1.TunnelEndpoint{})
...
func (c *FakeTunnelEndpoints) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(tunnelendpointsResource, c.ns, listOpts)
...
func (c *FakeTunnelEndpoints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TunnelEndpoint, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(tunnelendpointsResource, c.ns, name, pt, data, subresources...), &v1alpha1.TunnelEndpoint{})
